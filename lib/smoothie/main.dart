...
extension SmoothPoints on List<Point> {
  ///Creates a sampled curve going through [this] list of points.
  ///
  ///[oversamplingFactor] is a number of points of the resulting smoothed curve per single point of the original curve
  ///
  ///Returns a list of [oversamplingFactor] * [this.length] points that lay on a curve going through [this] points.
...
extension Smooth<POINT> on List<POINT> {
  ///Creates a sampled curve going through [this] list of custom data points.
  ///
  ///[oversamplingFactor] is a number of points of the resulting smoothed curve per single point of the original curve
